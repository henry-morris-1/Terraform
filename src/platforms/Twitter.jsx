    ...
    return(
        <>
            <section className="mt-3 border-b border-black">
                ...
                <Feature title="Premium features" description="Removes all premium features (analytics, grok, monetization, etc.) and solicitations" filters={filters} setFilters={setFilters} id={1} selectors={['[aria-label="Subscribe to Premium"]', '[aria-label="Premium"]', '[aria-label="Grok"]', '[aria-label="Profile Summary"]', '[aria-label="Verified Orgs"]', '[aria-label="Business"]', '[href="/settings/monetization"]', '[href="/i/premium_sign_up"]', '[href*="https://ads.x.com"]', '[href*="https://ads.twitter.com"]', '[href="/i/monetization"]', '[href="/i/account_analytics"]', '[href="/i/verified-orgs-signup"]', '[aria-label="Subscribe to Premium"]']} />
            </section>
